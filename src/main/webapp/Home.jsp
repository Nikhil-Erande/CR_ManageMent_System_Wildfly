...
<div>
        ...
        <h2>Hello <%= user %>,</h2><h4>Welcome to the Home Page</h4>
        
        <!-- Add Fetch Button -->
        <form action="searchServlet" method="post" onsubmit="showSearchResults()">
        <label for="crTitle">Search CR by Title:</label>
        <input type="text" id="crTitle" name="crTitle" >
        <button type=submit onclick="fetchRecords()">Search</button>
    </form>
